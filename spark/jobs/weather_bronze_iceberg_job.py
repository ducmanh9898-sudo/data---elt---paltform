...
BRONZE_TABLE = (
    "polaris.bronze.weather_hourly_raw"
)
...
def read_and_flatten_raw_data(
    ...
    # ========================================================
        ...
        col(
            "metadata.requested_forecast_days"
        )
        .cast("integer")
        .alias("requested_forecast_days"),
        ...
        col(
            "hourly_record.relative_humidity_2m"
        )
        .cast("double")
        .alias("relative_humidity_2m"),
        ...
        col(
            "hourly_record.wind_direction_10m"
        )
        .cast("double")
        .alias("wind_direction_10m"),
